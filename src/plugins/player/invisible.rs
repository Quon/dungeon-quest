...
pub fn invincible_cooldown(
    ...
    let mut invincible_cooldown = invincible_cooldown_query.single_mut().unwrap();
...
pub fn hurt_duration_color(
    ...
    let (invincible_cooldown, mut texture) = invincible_cooldown_query.single_mut().unwrap();
